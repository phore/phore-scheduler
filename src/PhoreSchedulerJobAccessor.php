...
class PhoreSchedulerJobAccessor
{
    ...
    public function addTask(string $command, array $arguments = [], $retries = 3, $timeout = 600) : self
    {
        $this->tasks[] = $task = new PhoreSchedulerTask($command, $arguments, $retries, $timeout);
        return $this;
    }
